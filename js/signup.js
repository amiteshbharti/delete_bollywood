...
var iChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?";
for (var i = 0; i < document.f1.txtfname.value.length; i++) {
    if (iChars.indexOf(document.f1.txtfname.value.charAt(i)) != -1) {
  ...
  /* var iChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?";
   if(document.f1.txtfname.value.indexOf(iChars) != -1) {
...
var iChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?";
for (var i = 0; i < document.f1.txtfathername.value.length; i++) {
    if (iChars.indexOf(document.f1.txtfathername.value.charAt(i)) != -1) {
    alert ("The father name has special characters. \nThese are not allowed.\n");
    return false;
        }
    }

var iChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?";
for (var i = 0; i < document.f1.txtlname.value.length; i++) {
    if (iChars.indexOf(document.f1.txtlname.value.charAt(i)) != -1) {
    alert ("The last name has special characters. \nThese are not allowed.\n");
    return false;
        }
    }
var iChars = "!@#$%^&*()+=-[]\\\';,./{}|\":<>?";
for (var i = 0; i < document.f1.txtuname.value.length; i++) {
    if (iChars.indexOf(document.f1.txtuname.value.charAt(i)) != -1) {
    alert ("The username has special characters. \nThese are not allowed.\n");
    return false;
        }
    }
